            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                ...
                <a href="/settings/categories?type=income"
                    ...
                    <div class="flex items-center space-x-4">
                        <i class="fas fa-inbox text-2xl text-green-600 group-hover:text-green-700"></i>
                        <div>
                ...
                <a href="/settings/categories?type=expense"
                    class="block px-6 py-4 border-b border-gray-100 hover:bg-blue-50 transition flex items-center justify-between group">
                    <div class="flex items-center space-x-4">
                        <i class="fas fa-shopping-cart text-2xl text-red-600 group-hover:text-red-700"></i>
                        <div>
                ...
                <a href="/settings/wallet-types"
                    class="block px-6 py-4 border-b border-gray-100 hover:bg-blue-50 transition flex items-center justify-between group">
                    <div class="flex items-center space-x-4">
                        <i class="fas fa-layer-group text-2xl text-purple-600 group-hover:text-purple-700"></i>
                        <div>
                ...
                <a href="/settings/wallets"
                    ...
                    <div class="flex items-center space-x-4">
                        <i class="fas fa-wallet text-2xl text-blue-600 group-hover:text-blue-700"></i>
                        <div>
